...
qk_tap_dance_action_t tap_dance_actions[] = {
  ...
  [tHM] = ACTION_TAP_DANCE_DUAL_ROLE(KC_RGUI, _QWERTY),
  [tGM] = ACTION_TAP_DANCE_DUAL_ROLE(KC_RGUI, _QWERTY),
 ...
 * | LSHIFT | Z      | X      | C      | V      | B      |                      | N      | M      | ,      | .      | /      | RSHIFT |
 * |--------+--------+--------+--------+--------+--------+--------.    .--------+--------+--------+--------------------------+--------|
 * | ESC    | OS     | ALT    | EISU   | FUNC   | NUMS   | SPACE  |    | LOWER  | RAISE  | KANA   | LEFT   | DOWN   | UP     | RSHIFT |
 * '--------------------------------------------------------------'    '--------------------------------------------------------------'
 */
[_LOWER] = LAYOUT( \
...
[_FUNC] = LAYOUT( \
    ...
    _______, _______, _______, _______, _______, _______, _______,      XXXXXXX, XXXXXXX, _______, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT \
),
...
[_ADJUST] =  LAYOUT( \
    ...
    _______, _______, _______, _______, _______, _______, _______,      XXXXXXX, XXXXXXX, _______, RGB_SMOD,RGB_HUD, RGB_SAD, RGB_VAD \
)
};
