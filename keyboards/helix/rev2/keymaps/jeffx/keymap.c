 ...
 */
 [_QWERTY] = LAYOUT( \
    ...
    KC_ESC,  _______, _______, KC_LGUI, KC_ALT,  LOWER,   KC_SPC,       LOWER,   RAISE,   FUNC,    _______, _______, _______, KC_DEL  \
),
...
[_LOWER] = LAYOUT( \
    ...
    _______, _______, _______, _______, _______, _______,                        _______, KC_MINS, KC_EQL,  _______, KC_QUOT, KC_MPLY, \
...
[_RAISE] = LAYOUT( \
    ...
    _______, _______, _______, _______, _______, _______,                        _______, KC_UNDS, KC_PLUS, _______, KC_DQUO, KC_MPLY, \
