...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT(
      ...
      KC_LCTL, KC_LGUI, TD(ALT_OSRAISE),                  KC_SPC,                 KC_RALT, RAISE,   KC_LEFT,  KC_DOWN, KC_RIGHT),
  ...
  [_RAISE] = LAYOUT(
      ...
      KC_LCTL, KC_LGUI, TD(ALT_OSRAISE),                  RESET,                  KC_RALT, KC_TRNS,           KC_HOME, BL_STEP,  KC_END)
