...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LAYOUT_directional(
      ...
      KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_SPC, KC_SPC, KC_KANA, MO(1), KC_LEFT, KC_DOWN, KC_RIGHT
      ),
  ...
  LAYOUT_directional(
      ...
      KC_CAPS, BL_TOGG, BL_STEP, BL_INC, BL_DEC, ______, ______, ______, ______, ______, ______, KC_MPLY,
